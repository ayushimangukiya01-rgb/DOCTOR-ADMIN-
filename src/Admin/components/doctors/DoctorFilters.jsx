    ...
    <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-xl p-5 sm:p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          ...
          {/* Specialization */}
          <select className="w-full sm:w-[180px] px-3 py-2.5 rounded-lg border border-gray-200 bg-white text-[14px] focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
          ...
          {/* Status */}
          <select className="w-full sm:w-[150px] px-3 py-2.5 rounded-lg border border-gray-200 bg-white text-[14px] focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
            <option>All</option>
